  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 bg-[#0d6084]">
        <div className="absolute inset-0 bg-[url('/src/assets/img/heroimg.jpg')] bg-cover bg-center bg-no-repeat opacity-70 mix-blend-multiply"></div>
      ...
      <div className="relative z-10 mx-auto px-6 text-center animate-fade-in max-w-5xl">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white leading-tight">
          Bi2B:{" "}
          <span className=" font-extrabold text-[#FF0000]">Inteligência</span>{" "}
          para sua Gestão
        </h1>
        <p className="text-xl md:text-2xl text-gray-100 mb-12 max-w-3xl mx-auto font-medium">
          Soluções completas em consultoria, dados e gestão contábil que
